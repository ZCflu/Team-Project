/**
 * The Dish class represents a dish in the restaurant menu.
...
public class Dish {
    ...
    private Recipe recipe; // Recipe object representing the ingredients and preparation instructions for the dish

    /**
     * Constructor to initialize a Dish object with provided dish ID, name, and recipe.
     * 
     * @param dishID Unique identifier for the dish.
     * @param dishName Name of the dish.
     * @param recipe Recipe object representing the ingredients and preparation instructions for the dish.
     */
     ...
     * 
     * @return Recipe object representing the ingredients and preparation instructions for the dish.
     */
