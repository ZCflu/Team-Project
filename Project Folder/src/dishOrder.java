/**
 * The dishOrder class represents an order for a specific dish in the restaurant.
...
public class dishOrder {
    ...
    /**
     * Constructor to initialize a dishOrder object with provided special request, order ID, and dish ID.
     * 
