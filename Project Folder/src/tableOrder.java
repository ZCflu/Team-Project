/**
 * The tableOrder class represents an order associated with a specific table in the restaurant.
 * It contains information about the table ID, order ID, whether the dishes should be sent together,
 * and an array of Dish objects representing the dishes ordered at the table.
 */
public class tableOrder {
    ...
    private Dish[] orders; // Array of Dish objects representing the dishes ordered at the table

    /**
     * Constructor to initialize a tableOrder object with provided table ID, order ID, sendTogether flag, and array of dishes.
     * 
     ...
     * @param dishes Array of Dish objects representing the dishes ordered at the table.
     */
    public tableOrder(int tableID, int orderID, boolean sendTogether, Dish[] dishes) {
    ...
    /**
     * Getter method to retrieve the array of Dish objects representing the dishes ordered at the table.
     * 
     * @return Array of Dish objects representing the dishes ordered at the table.
     */
    public Dish[] getOrders() {
        return this.orders;
    }
}
